...
<meta charset="UTF-8">
    ...
    <body>
      ...
      <h1 class="text-center">Todos los registros</h1><br><br>
      <div class="container">
          <div class="row">
          <div class="col-lg-6">
          ...
          <table id="myTable" class="sortable table-striped">
              ...
              <tbody>
              <?php
              $query= "SELECT alias,entrada,salida,tiempo,color,total FROM grupos";
              $result=  mysql_query($query);
             
              $numero=0;
              while($rows = mysql_fetch_array($result))
              {
                  echo "<tr><td width=\"15%\">".$rows["alias"]."</td>";
                 echo "<td width=\"20%\">".$rows["entrada"]."</td>";
                  echo "<td width=\"20%\">".$rows["salida"]."</td>";
                  echo "<td width=\"15%\">".$rows["tiempo"]."</td>";
                  echo "<td width=\"15%\">".$rows["color"]."</td>";
          ...
          <div class="col-lg-6">
              ...
              <div id="total">
              <?php 
         $query2= "SELECT SUM(total) AS suma FROM grupos";
         $result2=  mysql_query($query2);
         while($row =  mysql_fetch_array($result2)){
         echo "<p>TOTAL RECAUDADO DESDE INICIO: ".$row['suma']."€</p><br>";
         
         
         
         }
         echo "<p>TOTAL DE GRUPOS DESDE INICIO: ".$numero."</p>";
         ?> 
              </div>
