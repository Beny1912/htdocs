(function(window, document){
	...
	*/
	...
	function onsubmit(e){
		...
		if( estaVacio(data.telefono)){
			errores.push("El campo del telefono no puede estar vacío")
		}
	...
	*/
	nombre.required = email.required = telefono.required = mensaje.required = false;
	email.type = "text";
