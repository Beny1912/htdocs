...
return $FechaNueva;
	...
	{
		$dataProvider=new CActiveDataProvider('Registrosocio');
                    $this->renderPartial('/site/buscarsalida');
	...
	{
		$model=new Registrosocio('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Registrosocio']))
			$model->attributes=$_GET['Registrosocio'];
	...
	{
		$model=Registrosocio::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='registrosocio-form')
		{
