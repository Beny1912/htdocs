         ...
         <table class="sortable-theme-bootstrap" data-sortable>
              ...
              while($rows = mysqli_fetch_array($result))
              {
                 ...
                 echo "<td width=\"20%\">".$rows["entrada"]."</td>";
                  ...
                  echo "<td width=\"5%\"><a href=\"localhost/bolera/index.php?r=grupo/view&id=".$rows['grupo_id']."\" target=\"_blank\">Mostrar</a></td></tr>";
     ...
     <h1>SOCIOS</h1><br>
          <table class="sortable-theme-bootstrap" data-sortable>
              ...
              while($rows2 = mysqli_fetch_array($result2))
              {
                 ...
                 echo "<td><a href=\"localhost/bolera/index.php?r=gruposocio/view&id=".$rows2['grupo_id']."\" target=\"_blank\">Mostrar</a></td></tr>";
