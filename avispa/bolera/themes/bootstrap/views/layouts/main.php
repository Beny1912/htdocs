...
window.location.href="http://localhost/bolera/index.php?r=grupo/view&id="+data[i][0]+"";
}
...
window.location.href="http://localhost/bolera/index.php?r=gruposocio/view&id="+data[i][0]+"";
}
