	...
	function appendFeedbackToBody() {
		...
		if (fm_options.iframe_url === undefined) {
			form_html = '<form id="feedback_me_form">'
				...
				+		'<li>	<label for="feedback_message">' + fm_options.message_label + '</label> ' + message_asterisk + ' <textarea rows="4" id="feedback_message" ' + message_required + ' placeholder="' + fm_options.message_placeholder + '"></textarea> </li>'
