...
class GruposocioController extends Controller
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Gruposocio']))
		{
            ...
            MultiModelForm::save($socioG,$validatedMembers,$deleteMembers,$masterValues) &&
            $model->save()
           ){
	...
	{
		$dataProvider=new CActiveDataProvider('Gruposocio');
                $this->renderPartial('/site/buscarsalida');
	...
	{
		$model=new Gruposocio('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gruposocio']))
			$model->attributes=$_GET['Gruposocio'];
	...
	{
		$model=Gruposocio::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gruposocio-form')
		{
