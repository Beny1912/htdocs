...
<?php /*%%SmartyHeaderCode:1345571564530ff8f4706c21-30251336%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1345571564530ff8f4706c21-30251336',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530ff8f4b57524_72608211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530ff8f4b57524_72608211')) {function content_530ff8f4b57524_72608211($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['name'], 'html', 'UTF-8');?>
 ...
 : <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['reference'], 'html', 'UTF-8');?>
</small><?php }?>
...
"><span><i class="icon-plus"></i></span></a>
	...
	<?php }elseif(!isset($_smarty_tpl->tpl_vars['cannotModify']->value)){?>
			<td class="cart_gift_quantity text-center"><?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])){?><input size="2" type="text" autocomplete="off" disabled="disabled" class="cart_quantity_input form-control grey" value="1" /><?php }?></td>
