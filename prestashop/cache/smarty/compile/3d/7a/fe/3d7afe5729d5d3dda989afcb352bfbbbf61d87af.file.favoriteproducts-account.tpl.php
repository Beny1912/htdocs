...
<?php /*%%SmartyHeaderCode:55429887530ff8ee6fc557-01764703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '55429887530ff8ee6fc557-01764703',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530ff8ee7aacf8_49947981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530ff8ee7aacf8_49947981')) {function content_530ff8ee7aacf8_49947981($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
?>
			<li class="col-xs-12">
            	<div class="favoriteproduct clearfix inner-content">
                    ...
                    href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['favoriteProduct']->value['id_product'],null,null,null,null,$_smarty_tpl->tpl_vars['favoriteProduct']->value['id_shop']), 'html', 'UTF-8');?>
">
                        <img 
                        src="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['favoriteProduct']->value['link_rewrite'],$_smarty_tpl->tpl_vars['favoriteProduct']->value['image'],'medium_default'), 'html', 'UTF-8');?>
" 
                        alt=""/>
                    </a>
