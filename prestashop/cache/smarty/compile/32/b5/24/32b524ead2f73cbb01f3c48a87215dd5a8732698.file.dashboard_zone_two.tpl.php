...
<?php /*%%SmartyHeaderCode:1528924248530ffb1ca8e217-26121831%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1528924248530ffb1ca8e217-26121831',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530ffb1cafe0d9_71447042',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530ffb1cafe0d9_71447042')) {function content_530ffb1cafe0d9_71447042($_smarty_tpl) {?>

<div class="clearfix "></div>
<section id="dashproducts" class="panel widget">
	<header class="panel-heading">
		<i class="icon-bar-chart"></i> <?php echo smartyTranslate(array('s'=>'Product and Sales','mod'=>'dashproducts'),$_smarty_tpl);?>
	...
	<section>
			...
			<ul class="nav nav-pills">
				...
				<li>
					<a href="#dash_top_search" data-toggle="tab">
						...
						<span class="hidden-inline-xs"><?php echo smartyTranslate(array('s'=>'Top Search','mod'=>'dashproducts'),$_smarty_tpl);?>
</span>
					</a>
				</li>
			</ul>
		...
		<div class="tab-content panel">
			...
			<div class="tab-pane" id="dash_best_sellers">
				<h3><?php echo smartyTranslate(array('s'=>'Top %d products','sprintf'=>intval($_smarty_tpl->tpl_vars['DASHPRODUCT_NBR_SHOW_BEST_SELLER']->value),'mod'=>'dashproducts'),$_smarty_tpl);?>

				<span class="badge"><?php echo smartyTranslate(array('s'=>"From",'mod'=>'dashproducts'),$_smarty_tpl);?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['date_to']->value;?>
			...
			<div class="tab-pane" id="dash_most_viewed">
				<h3><?php echo smartyTranslate(array('s'=>"Most Viewed",'mod'=>'dashproducts'),$_smarty_tpl);?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['date_to']->value;?>
			...
			<div class="tab-pane" id="dash_top_search">
				<h3><?php echo smartyTranslate(array('s'=>'Top %d most search terms','sprintf'=>intval($_smarty_tpl->tpl_vars['DASHPRODUCT_NBR_SHOW_TOP_SEARCH']->value),'mod'=>'dashproducts'),$_smarty_tpl);?>
