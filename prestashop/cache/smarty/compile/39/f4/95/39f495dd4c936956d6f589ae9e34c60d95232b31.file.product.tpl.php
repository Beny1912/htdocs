<?php /* Smarty version Smarty-3.1.14, created on 2014-02-28 03:48:19
         compiled from "/Applications/MAMP/htdocs/prestashop/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1444388274530ff8f3101db8-28117178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1444388274530ff8f3101db8-28117178',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530ff8f4070172_61444488',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530ff8f4070172_61444488')) {function content_530ff8f4070172_61444488($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/modifier.escape.php';
...
?>
								...
								<?php if (!empty($_smarty_tpl->tpl_vars['image']->value['legend'])){?>
									<?php $_smarty_tpl->tpl_vars['imageTitle'] = new Smarty_variable(smarty_modifier_escape($_smarty_tpl->tpl_vars['image']->value['legend'], 'html', 'UTF-8'), null, 0);?>
								<?php }else{ ?>
									<?php $_smarty_tpl->tpl_vars['imageTitle'] = new Smarty_variable(smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'html', 'UTF-8'), null, 0);?>
								<?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<p id="product_condition"<?php if (!$_smarty_tpl->tpl_vars['product']->value->condition){?> style="display: none;"<?php }?>>
				...
				<span class="editable" itemprop="condition"><?php echo smarty_modifier_escape(Smarty::$_smarty_vars['capture']['condition'], 'html', 'UTF-8');?>
</span>
			</p>
...
?>
					<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['attachements']['iteration']%3==1){?><div class="row"><?php }?>
						<div class="col-lg-4">
							<h4><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), 'html', 'UTF-8');?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attachment']->value['name'], 'html', 'UTF-8');?>
</a></h4>
							<p class="text-muted"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attachment']->value['description'], 'html', 'UTF-8');?>
</p>
							<a class="btn btn-default btn-block" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), 'html', 'UTF-8');?>
">
...
loader.gif" alt="loader" />
		...
		<?php }?>
	<?php }?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('allowBuyWhenOutOfStock'=>$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['boolval'][0][0]->boolval($_smarty_tpl->tpl_vars['allow_oosp']->value)),$_smarty_tpl);?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('availableNowValue'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->available_now, 'quotes', 'UTF-8')),$_smarty_tpl);?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('availableLaterValue'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->available_later, 'quotes', 'UTF-8')),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('productReference'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->reference, 'html', 'UTF-8')),$_smarty_tpl);?>
