...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_530ffd727559d0_11489093',
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530ffd727559d0_11489093')) {function content_530ffd727559d0_11489093($_smarty_tpl) {?>    <!-- Module HomeSlider -->
            <div id="homepage-slider">
            <ul id="homeslider">
                                                            <li class="homeslider-container">
                            <a href="http://www.prestashop.com/?utm_source=v16_homeslider" title="sample-1">
                                <img width="779" height="100%" src="http://localhost:8888/prestashop/modules/homeslider/images/sample-1.jpg" alt="sample-1" />
                            </a>
				...
				<p><button class="btn btn-default" type="button">Shop now !</button></p></div>
                            ...
                            <a href="http://www.prestashop.com/?utm_source=v16_homeslider" title="sample-2">
                                <img width="779" height="100%" src="http://localhost:8888/prestashop/modules/homeslider/images/sample-2.jpg" alt="sample-2" />
                            </a>
                                                            <div class="homeslider-description"><h2>EXCEPTEUR<br />OCCAECAT</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tristique in tortor et dignissim. Quisque non tempor leo. Maecenas egestas sem elit</p>
				<p><button class="btn btn-default" type="button">Shop now !</button></p></div>
                            ...
                            <a href="http://www.prestashop.com/?utm_source=v16_homeslider" title="sample-3">
                                <img width="779" height="100%" src="http://localhost:8888/prestashop/modules/homeslider/images/sample-3.jpg" alt="sample-3" />
                            </a>
                                                            <div class="homeslider-description"><h2>EXCEPTEUR<br />OCCAECAT</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tristique in tortor et dignissim. Quisque non tempor leo. Maecenas egestas sem elit</p>
				<p><button class="btn btn-default" type="button">Shop now !</button></p></div>
